...
public static class PayloadGenerator
{
    ...
    public class OneTimePassword : Payload
    {
        ...
        {
            StringBuilder sb = new("otpauth://hotp/");
        ...
        private string TimeToString()
        {
            ...
            StringBuilder sb = new("otpauth://totp/");
    ...
    public class ShadowSocksConfig : Payload
    {
        ...
        private Dictionary<string, string> encryptionTexts = new() {
        ...
        { }
        private Dictionary<string, string> UrlEncodeTable = new()
        {
            [" "] = "+",
            ["\0"] = "%00",
            ["\t"] = "%09",
